Mars Photos
==================================
En esta rama main del proyecto se recuperan las fotos y se renderizan las imagenes
con el componente AsyncImage. No se utiliza inyeccion de dependencias
